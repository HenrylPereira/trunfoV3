...
export const cartasCarros: cardInterface[] = [
  {
    titulo: 'McLaren Senna',
       ...
       atributos: [
         ...
         { titulo: 'conforto', valor: 100 },
         { titulo: '0 a 100', valor: 100 },
         { titulo: 'Aéreo Dinâmica', valor: 100 },
       ],
       cor: '#FFB906',
    ...
    },
    {
     ...
     indice: 'A3',
     atributos: [
       { titulo: 'Velocidade Max', valor: 90},
       { titulo: 'Potência(Cv)', valor: 94 },
       { titulo: 'conforto', valor: 82 },
       { titulo: '0 a 100', valor: 89 },
       { titulo: 'Aéreo Dinâmica', valor: 87 },
     ],
     cor: '#FF0909',
    ...
    },
    {
     ...
     indice: 'B1',
     atributos: [
       { titulo: 'Velocidade Max', valor: 95 },
       { titulo: 'Potência(Cv)', valor: 92 },
       { titulo: 'conforto', valor: 81 },
       { titulo: '0 a 100', valor: 88 },
       { titulo: 'Aéreo Dinâmica', valor: 86 },
     ],
     cor: '#FF0909',
    ...
    },
    {
     ...
     indice: 'B2',
     atributos: [
       { titulo: 'Velocidade Max', valor: 93 },
       { titulo: 'Potência(Cv)', valor: 90 },
       { titulo: 'conforto', valor: 80 },
       { titulo: '0 a 100', valor: 95 },
       { titulo: 'Aéreo Dinâmica', valor: 83 },
     ],
     cor: '#FF0909',
    ...
    },
    {
     ...
     indice: 'C2',
     atributos: [
       { titulo: 'Velocidade Max', valor: 78 },
       { titulo: 'Potência(Cv)', valor: 86 },
       { titulo: 'conforto', valor: 84 },
       { titulo: '0 a 100', valor: 75 },
       { titulo: 'Aéreo Dinâmica', valor: 89 },
     ],
     cor: '#FF0909',
    ...
    },
    {
     ...
     indice: 'C3',
     atributos: [
       { titulo: 'Velocidade Max', valor: 85 },
       { titulo: 'Potência(Cv)', valor: 89 },
       { titulo: 'conforto', valor: 88 },
       { titulo: '0 a 100', valor: 78 },
       { titulo: 'Aéreo Dinâmica', valor: 92 },
     ],
     cor: '#FF0909',
    ...
    },
    {
     ...
     atributos: [
       ...
       { titulo: 'Potência(Cv)', valor: 95 },
       { titulo: 'conforto', valor: 79 },
       { titulo: '0 a 100', valor: 73 },
       { titulo: 'Aéreo Dinâmica', valor: 91 },
     ],
     cor: '#FF0909',
    ...
    },
    {
     ...
     indice: 'D2',
     atributos: [
       { titulo: 'Velocidade Max', valor: 70 },
       { titulo: 'Potência(Cv)', valor: 75 },
       { titulo: 'conforto', valor: 98 },
       { titulo: '0 a 100', valor: 50 },
       { titulo: 'Aéreo Dinâmica', valor: 60 },
     ],
     cor: '#FF0909',
...

    {
     ...
     atributos: [
       ...
       { titulo: 'Potência(Cv)', valor: 87 },
       { titulo: 'conforto', valor: 85 },
    ...
    },
    {
     ...
     indice: 'E1',
     atributos: [
       { titulo: 'Velocidade Max', valor: 80 },
       { titulo: 'Potência(Cv)', valor: 84 },
       { titulo: 'conforto', valor: 90 },
